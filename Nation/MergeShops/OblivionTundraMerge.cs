...
private static CoreAdvanced _sAdv;
    ...
    private static FiendishLoreMasterMerge FLM { get => _FLM ??= new FiendishLoreMasterMerge(); set => _FLM = value; }
    private static FiendishLoreMasterMerge _FLM;
    private static OblivionTundra OT { get => _OT ??= new OblivionTundra(); set => _OT = value; }
